  ...
  return (
    <section className='max-container'>
      ...
      <div className='flex flex-col gap-3 mt-5 text-slate-500'>
        <p>
        A Engineering Student From Bhopal, Madhya pradesh, specializing in Artifial Intelligence & Machine Learning
        </p>
      </div>
      ...
      <div className='py-16'>
        <h3 className='subhead-text'>Summary</h3>
        <div className='flex flex-col gap-3 mt-5 text-slate-500'>
          <p>
            I've worked on many projects, leveling up my skills. Here's the rundown:
          </p>
        </div>
